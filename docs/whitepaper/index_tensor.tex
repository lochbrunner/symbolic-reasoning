...
$\phi'_=={\color{red}w_1\phi_=}+{\color{blue}w_2\phi_+}+{\color{green!70!black}w_3\phi_-}+{\color{orange!80!black}w_2\phi_{\text{PAD}}}$]  
{
...
$\phi'_+={\color{red}w_1\phi_+}+{\color{blue}w_2\phi_a}+{\color{green!70!black}w_3\phi_b}+{\color{orange!80!black}w_2\phi_=}$]  
{
\tikzset{g_style/.style={black, draw=black!15, minimum size=0.5cm}}
\begin{tikzpicture}
...
\subfigure[Neighbors of a leaf
$\phi'_b={\color{red}w_1\phi_b}+{\color{blue}w_2\phi_{\text{PAD}}}+{\color{green!70!black}w_3\phi_{\text{PAD}}}+{\color{orange!80!black}w_2\phi_+}$]  
{
\tikzset{g_style/.style={black, draw=black!15, minimum size=0.5cm}}
\begin{tikzpicture}
    \node[g_style] (=) at (0,0){=};
...
\caption{
    ...
    Sub-figure (b) shows the computation of the next value $\phi'$ for the node $a$ in that term.
It is the weighted sum of the current values of if self, their children and the parent in a fixed order.
As the root in (a) has not parent node, we use the padding as an default.
